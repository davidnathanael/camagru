...
try {
	...
	$DB->exec("CREATE TABLE users(id INT PRIMARY KEY AUTO_INCREMENT, login VARCHAR(255) UNIQUE NOT NULL, mail VARCHAR(255) UNIQUE NOT NULL, confirmed BOOLEAN NOT NULL DEFAULT 0, confirmation_hash VARCHAR(255) NOT NULL, resetpw_hash VARCHAR(255), password VARCHAR(255) NOT NULL, createdAt TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP)");
